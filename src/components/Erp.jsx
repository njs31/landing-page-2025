...
const LMSFeaturesGrid = () => {
  ...
  useEffect(() => {
    ...
    if (container) {
      ...
      setCardHeight(containerHeightRef.current - 20); 
    }
  }, []);

  return (
    <Box sx={{ bgcolor: '#1a2a42', borderBottom: '0.5px solid pink', color: 'white', minHeight: '100vh', py: 6, px: 2 }}>
      <Container maxWidth="lg" sx={{ height: '100%' }}>
        ...
        <Box sx={{ position: 'relative', width: '100%', overflow: 'hidden', mb: 4, height: 'calc(100% - 200px)' }}>
          <Box
