...
const LetsTalk = () => {
  return (
    <Grid container spacing={4} sx={{ px: { xs: 2, md: 8 }, py: 6, bgcolor: "#e0f7fa" }}>
      
      <Grid item xs={12} md={6}>
        <Paper elevation={3} sx={{ p: 4, borderRadius: 3, bgcolor: "#ffffff" }}>
          <Typography variant="h5" fontWeight="bold" textAlign="center" sx={{ color: "#0288d1" }}>
            Contact Us
          </Typography>
          <hr style={{ width: "60px", border: "2px solid #0288d1", margin: "10px auto 20px" }} />
      ...
      <Grid item xs={12} md={6}>
        <Paper elevation={3} sx={{ p: 4, borderRadius: 3, bgcolor: "#ffffff" }}>
          <Typography variant="h6" display="flex" alignItems="center" fontWeight="bold" sx={{ color: "#0288d1" }}>
            <LocationOnIcon sx={{ color: "#0288d1", mr: 1 }} /> Find us at the office
          </Typography>
